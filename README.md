...
A professional crypto trading platform built with React, Zustand, and Alpaca API. Trade
cryptocurrencies with both paper trading (virtual money) and live trading modes.
Features
...
1. 2. 3. 4. Go to Alpaca Paper Trading
Sign up for free account
Navigate to “API Keys” section
Generate new paper trading API keys
5. Copy API Key and Secret Key
Live Trading (Real Money)
1. Go to Alpaca Live Trading
